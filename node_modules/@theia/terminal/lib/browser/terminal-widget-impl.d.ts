...
import { Widget, Message, StatefulWidget, ExtractableWidget, ContextMenuRenderer } from '@theia/core/lib/browser';
...
import { TerminalWidgetOptions, TerminalWidget, TerminalDimensions, TerminalExitStatus, TerminalLocationOptions, TerminalBuffer } from './base/terminal-widget';
...
export declare class TerminalWidgetImpl extends TerminalWidget implements StatefulWidget, ExtractableWidget, EnhancedPreviewWidget {
    ...
    readonly _terminalDOMId: string;
    ...
    protected readonly onOutputEmitter: Emitter<string>;
    ...
    protected readonly onShellTypeChangedEmiter: Emitter<string>;
    readonly onShellTypeChanged: Event<string>;
    ...
    private setCursorBlink;
    private setCursorStyle;
    private setCursorWidth;
