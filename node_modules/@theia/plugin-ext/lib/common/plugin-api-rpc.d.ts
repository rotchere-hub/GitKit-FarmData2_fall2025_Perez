...
export declare const PLUGIN_RPC_CONTEXT: {
    ...
    MCP_SERVER_DEFINITION_REGISTRY_MAIN: ProxyIdentifier<McpServerDefinitionRegistryMain>;
};
export declare const MAIN_RPC_CONTEXT: {
    ...
    URI_EXT: ProxyIdentifier<UriExt>;
    MCP_SERVER_DEFINITION_REGISTRY_EXT: ProxyIdentifier<McpServerDefinitionRegistryExt>;
};
