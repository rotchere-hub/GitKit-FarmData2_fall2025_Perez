...
export interface EvaluatableExpressionProvider {
    provideEvaluatableExpression(model: monaco.editor.ITextModel, position: monaco.Position, token: monaco.CancellationToken): EvaluatableExpression | undefined | Thenable<EvaluatableExpression | undefined>;
}
...
export interface InlineValuesProvider {
    ...
    provideInlineValues(model: monaco.editor.ITextModel, viewPort: Range, context: InlineValueContext, token: monaco.CancellationToken): InlineValue[] | undefined | Thenable<InlineValue[] | undefined>;
}
...
export type CachedSessionItem<T> = T & {
    cacheId?: ChainedCacheId;
};
export type CachedSession<T> = T & {
    cacheId?: CacheId;
};
...
export type CodeActionProviderDocumentation = ReadonlyArray<{
    command: Command;
    kind: string;
}>;
export interface CodeActionProvider {
    provideCodeActions(model: monaco.editor.ITextModel, range: Range | Selection, context: monaco.languages.CodeActionContext, token: monaco.CancellationToken): CodeAction[] | PromiseLike<CodeAction[]>;
...
export declare class HierarchyItem {
    _sessionId?: string;
    _itemId?: string;
    kind: SymbolKind;
...
export declare class TypeHierarchyItem extends HierarchyItem {
}
...
export interface InlineCompletionsProvider<T extends InlineCompletions = InlineCompletions> {
    provideInlineCompletions(model: monaco.editor.ITextModel, position: monaco.Position, context: InlineCompletionContext, token: monaco.CancellationToken): T[] | undefined | Thenable<T[] | undefined>;
    /**
...
//# sourceMappingURL=plugin-api-rpc-model.d.ts.map