...
export declare class CustomEditorsExtImpl implements CustomEditorsExt {
    ...
    constructor(rpc: RPCProtocol, documentExt: DocumentsExtImpl, webviewExt: WebviewsExtImpl);
    ...
    $resolveWebviewEditor(resource: UriComponents, handler: string, viewType: string, title: string, position: number, options: theia.WebviewPanelOptions, cancellation: CancellationToken): Promise<void>;
    ...
    $save(resourceComponents: UriComponents, viewType: string, cancellation: CancellationToken): Promise<void>;
    $saveAs(resourceComponents: UriComponents, viewType: string, targetResource: UriComponents, cancellation: CancellationToken): Promise<void>;
