...
import { FileSystemExt, FileSystemMain } from '../common/plugin-api-rpc';
...
declare class ConsumerFileSystem implements vscode.FileSystem {
    private _proxy;
    private _capabilities;
    apiObject: vscode.FileSystem;
    constructor(_proxy: FileSystemMain, _capabilities: Map<string, number>);
...
export declare class FileSystemExtImpl implements FileSystemExt {
    ...
    readonly onWillRegisterFileSystemProvider: import("@theia/core/lib/common").Event<FsLinkProvider>;
    private _handlePool;
