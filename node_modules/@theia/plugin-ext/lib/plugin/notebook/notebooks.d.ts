...
import { NotebookCellStatusBarListDto, NotebookDataDto, NotebookDocumentsAndEditorsDelta, NotebooksExt, Plugin } from '../../common';
...
export declare class NotebooksExtImpl implements NotebooksExt {
    ...
    private readonly notebookProxy;
    private readonly notebookDocumentsProxy;
    private readonly notebookEditors;
    private readonly logger;
    constructor(rpc: RPCProtocol, commands: CommandRegistryImpl, textDocumentsAndEditors: EditorsAndDocumentsExtImpl, textDocuments: DocumentsExtImpl);
    ...
    waitForNotebookDocument(uri: TheiaURI, duration?: number): Promise<NotebookDocument>;
    private createExtHostEditor;
    private waitForNotebookEditor;
