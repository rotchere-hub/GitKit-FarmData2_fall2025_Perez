...
import { Disposable, DisposableGroup, Event } from '@theia/core';
...
export declare class Memento implements theia.Memento {
    ...
    private cache;
    constructor(pluginId: string, isPluginGlobalData: boolean, storage: InternalStorageExt);
    keys(): string[];
...
export declare const InternalStorageExt: unique symbol;
 ...
 */
export declare class KeyValueStorageProxy implements InternalStorageExt {
