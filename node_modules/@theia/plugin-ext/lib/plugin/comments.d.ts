...
export declare class CommentsExtImpl implements CommentsExt {
    ...
    $provideCommentingRanges(commentControllerHandle: number, uriComponents: UriComponents, token: theia.CancellationToken): Promise<{
        ranges: Range[];
...
export declare class ExtHostCommentThread implements theia.CommentThread, theia.Disposable {
    ...
    constructor(proxy: CommentsMain, commentController: CommentController, _id: string | undefined, _uri: theia.Uri, _range: theia.Range | undefined, _comments: theia.Comment[], extensionId: string);
