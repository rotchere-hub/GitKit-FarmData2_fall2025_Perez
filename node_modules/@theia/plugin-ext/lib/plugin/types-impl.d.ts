...
export declare class LanguageModelChatMessage {
    ...
    constructor(role: LanguageModelChatMessageRole, content: string | (LanguageModelTextPart | LanguageModelToolResultPart | LanguageModelToolCallPart)[], name?: string | undefined);
}
