...
export declare class DebugExtImpl implements DebugExt {
    ...
    private readonly onDidChangeActiveStackItemEmitter;
    ...
    $onDidChangeActiveThread(debugThread: DebugThreadDTO | undefined): Promise<void>;
    $onDidChangeActiveFrame(debugFrame: DebugStackFrameDTO | undefined): Promise<void>;
