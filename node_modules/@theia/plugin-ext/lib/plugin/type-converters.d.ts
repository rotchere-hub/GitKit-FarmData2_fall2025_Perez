...
import { ThemeIcon, URI } from './types-impl';
...
export declare function fromPosition(position: types.Position | theia.Position | undefined): Position | undefined;
export declare function toPosition(position: Position): types.Position;
export declare function toPosition(position: Position | undefined): types.Position | undefined;
...
export declare function fromLocationToLanguageServerLocation(location: theia.Location): lstypes.Location;
export declare function fromLocationToLanguageServerLocation(location: theia.Location | undefined): lstypes.Location | undefined;
 ...
 */
export declare function toMergedSymbol(uri: UriComponents, symbol: model.DocumentSymbol): theia.SymbolInformation & theia.DocumentSymbol;
...
export declare function convertIconPath(iconPath: types.URI | {
    light: types.URI;
    dark: types.URI;
} | theia.ThemeIcon | undefined): UriComponents | {
    light: UriComponents;
    dark: UriComponents;
} | ThemeIcon | undefined;
export declare function convertQuickInputButton(plugin: Plugin, button: theia.QuickInputButton, index: number): rpc.TransferQuickInputButton;
export declare function convertToTransferQuickPickItems(plugin: Plugin, items: (theia.QuickPickItem | string)[]): rpc.TransferQuickPickItem[];
...
export declare namespace TestMessageStackFrame {
    function from(stackTrace: theia.TestMessageStackFrame): TestMessageStackFrameDTO;
}
