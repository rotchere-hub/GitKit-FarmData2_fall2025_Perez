...
export declare class MainCustomEditorModel implements CustomEditorModel {
    ...
    readonly onContentChanged: import("@theia/core").Event<void>;
    static create(proxy: CustomEditorsExt, viewType: string, resource: TheiaURI, undoRedoService: UndoRedoService, fileService: FileService, cancellation: CancellationToken): Promise<MainCustomEditorModel>;
    constructor(proxy: CustomEditorsExt, viewType: string, editorResource: TheiaURI, editable: boolean, undoRedoService: UndoRedoService, fileService: FileService);
    get resource(): URI;
    get dirty(): boolean;
    ...
    saveCustomEditor(options?: SaveOptions): Promise<void>;
    saveAs(options: SaveAsOptions): Promise<void>;
    saveCustomEditorAs(resource: TheiaURI, targetResource: TheiaURI, options?: SaveOptions): Promise<void>;
    undo(): Promise<void>;
    redo(): Promise<void>;
    private spliceEdits;
...
export declare class CustomTextEditorModel implements CustomEditorModel {
    ...
    private readonly onContentChangedEmitter;
    readonly onContentChanged: import("@theia/core").Event<void>;
    static create(viewType: string, resource: TheiaURI, editorModelService: EditorModelService): Promise<CustomTextEditorModel>;
    constructor(viewType: string, editorResource: TheiaURI, model: Reference<MonacoEditorModel>);
    dispose(): void;
    get resource(): URI;
    get dirty(): boolean;
    get readonly(): boolean;
