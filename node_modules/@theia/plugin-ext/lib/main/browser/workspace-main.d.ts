...
import { WorkspaceExt, WorkspaceMain, WorkspaceFolderPickOptionsMain, FindFilesOptions } from '../../common/plugin-api-rpc';
...
export declare class WorkspaceMainImpl implements WorkspaceMain, Disposable {
    ...
    $startFileSearch(includePattern: string, includeFolderUri: string | undefined, options: FindFilesOptions): Promise<UriComponents[]>;
    ...
    $getValidEncoding(uri: UriComponents | undefined, detectedEncoding: string | undefined, options: {
        encoding: string;
    } | undefined): Promise<string>;
    getPreferredReadEncoding(uri: UriComponents | undefined, options?: {
        encoding?: string;
    }, detectedEncoding?: string): Promise<string>;
}
/**
