...
import { FrontendApplication, FrontendApplicationContribution, KeybindingRegistry, OpenerService, PreferenceService, Widget, NavigatableWidget, OpenWithService } from '@theia/core/lib/browser';
import { CommandRegistry, MenuModelRegistry, MenuPath, Mutable, QuickInputService } from '@theia/core/lib/common';
