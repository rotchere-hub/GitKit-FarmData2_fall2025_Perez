...
export declare namespace DebugCommands {
    ...
    const ENABLE_SELECTED_BREAKPOINTS: Command;
    const ENABLE_ALL_BREAKPOINTS: Command;
    const DISABLE_SELECTED_BREAKPOINTS: Command;
