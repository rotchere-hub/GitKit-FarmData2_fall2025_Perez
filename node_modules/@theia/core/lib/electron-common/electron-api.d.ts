...
export declare const CHANNEL_WC_METADATA = "WebContentMetadata";
...
export declare const CHANNEL_OPEN_WITH_SYSTEM_APP = "OpenWithSystemApp";
...
export declare const CHANNEL_SET_BACKGROUND_COLOR = "SetBackgroundColor";
export declare const CHANNEL_SET_THEME = "SetTheme";
...
export declare const CHANNEL_ABOUT_TO_CLOSE = "AboutToClose";
export declare const CHANNEL_OPEN_URL = "OpenUrl";
