import { BoxLayout, BoxPanel, DockLayout, DockPanel, FocusTracker, Layout, Panel, SplitLayout, TabBar, Widget, Title } from '@lumino/widgets';
import { Message } from '@lumino/messaging';
import { Drag } from '@lumino/dragdrop';
import { RecursivePartial, Event as CommonEvent, DisposableCollection, UntitledResourceResolver } from '../../common';
...
export declare class ApplicationShell extends Widget {
    ...
    protected readonly onDidDoubleClickMainAreaEmitter: Emitter<void>;
    readonly onDidDoubleClickMainArea: CommonEvent<void>;
    ...
    protected initializedDeferred: Deferred<void>;
