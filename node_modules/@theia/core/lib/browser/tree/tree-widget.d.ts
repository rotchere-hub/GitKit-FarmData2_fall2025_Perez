...
import { MenuPath, SelectionService, Event as TheiaEvent, Emitter } from '../../common';
 ...
 */
export declare const SCROLL_BOTTOM_THRESHOLD = 30;
/**
...
export declare class TreeWidget extends ReactWidget implements StatefulWidget {
    ...
    protected readonly onScrollEmitter: Emitter<TreeScrollEvent>;
    readonly onScroll: TheiaEvent<TreeScrollEvent>;
...
export declare namespace TreeWidget {
     ...
     */
    interface ViewProps extends VirtuosoProps<unknown, unknown> {
        /**
         * The width property.
         */
        width: number;
