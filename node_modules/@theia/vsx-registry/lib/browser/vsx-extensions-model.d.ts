...
import { OVSXClient, VSXAllVersions, VSXSearchEntry, VSXSearchOptions } from '@theia/ovsx-client/lib/ovsx-types';
...
export declare class VSXExtensionsModel {
    ...
    protected uninstalled: Set<`${string}.${string}`>;
    protected deployed: Set<`${string}.${string}`>;
    protected _installed: Set<`${string}.${string}`>;
    ...
    protected findReadmeFile(extension: VSXExtension): Promise<URI | undefined>;
    ...
    protected fetchVerifiedStatus(id: string, client: OVSXClient, allVersions: VSXAllVersions): Promise<boolean | undefined>;
